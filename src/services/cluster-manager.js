...
class ClusterClient {
  constructor(clusterInfo, clusterSecret) {
...
class ClusterManager {
  constructor(clusterDiscovery, clusterSecret) {
    this.discovery = clusterDiscovery;
    this.secret = clusterSecret || process.env.CLUSTER_SECRET || 'your-cluster-secret-key';
  ...
  connectToCluster(cluster) {
    ...
    const client = new ClusterClient(cluster, this.secret);
